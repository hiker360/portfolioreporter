...
public class PortfolioController : Controller
{
    ...
    public PortfolioController(PortfolioCalculationService portfolioCalculationService)
    {
    ...
    public IActionResult Index()
    {
        ...
        // Convert portfolio returns into the correct dictionary format for the table
